...
alter table room add event_dept_id number(20);
alter table non_university_location add event_dept_id number(20);
...
alter table department add allow_events number(1) default 0;

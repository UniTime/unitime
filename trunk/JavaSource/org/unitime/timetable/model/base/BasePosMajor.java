...
/**
 * This is an object that contains data related to the POS_MAJOR table.
...
public abstract class BasePosMajor  implements Serializable {
	...
	public static String REF = "PosMajor";
	 ...
	 */
	public BasePosMajor (java.lang.Long uniqueId) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof org.unitime.timetable.model.PosMajor)) return false;
		else {
			org.unitime.timetable.model.PosMajor posMajor = (org.unitime.timetable.model.PosMajor) obj;
			if (null == this.getUniqueId() || null == posMajor.getUniqueId()) return false;
			else return (this.getUniqueId().equals(posMajor.getUniqueId()));
		}
	}

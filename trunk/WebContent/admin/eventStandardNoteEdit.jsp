...
<html:form action="/eventStandardNoteEdit">
...
<html:hidden property="id"/>
	...
	<TABLE width="90%" border="0" cellspacing="0" cellpadding="3">
		...
		<TR>
			<TD colspan='2'>
					<logic:notEqual name="eventStandardNoteEditForm" property="screen" value="add">		
						<tt:section-header>
						<tt:section-title> Edit Note</tt:section-title>
						...
						<html:submit property="op" styleClass="btn" accesskey="B" 
							title="Back to Standard Event Notes (Alt+B)" value="Back"/>
						</tt:section-header>
					</logic:notEqual>
					<logic:equal name="eventStandardNoteEditForm" property="screen" value="add">
						<tt:section-header>
						<tt:section-title> Add a New Standard Note</tt:section-title>

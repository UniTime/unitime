...
alter table event_contact modify phone varchar(25);
...
update sessions set event_begin_date = adddate(session_begin_date_time,-31);
...
update sessions set event_end_date = adddate(session_end_date_time,31);

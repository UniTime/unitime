...
alter table service_provider add session_id decimal(20,0);
alter table service_provider add department_id decimal(20,0);
alter table service_provider add all_rooms int(1) default 1;
alter table service_provider add visible int(1) default 1;

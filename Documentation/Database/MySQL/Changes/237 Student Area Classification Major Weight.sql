...
alter table student_area_clasf_major add weight double default 1.0;
alter table pit_stu_aa_major_clasf add concentration_id decimal(20,0);
alter table pit_stu_aa_major_clasf add weight double default 1.0;

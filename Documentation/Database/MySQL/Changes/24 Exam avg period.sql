...
alter table exam add avg_period bigint(10);

/**
 * Add organized flag to itype_desc
 */
 
alter table itype_desc add organized int(1);
...
alter table itype_desc modify organized int(1) not null;
 
 /**
  * Add email to departmental instructor
  */

alter table departmental_instructor add email varchar(200);

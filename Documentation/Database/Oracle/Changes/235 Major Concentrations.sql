...
alter table pos_major_conc add constraint pk_pos_major_conc primary key (uniqueid);
...
alter table student_area_clasf_major add concentration_id number(20,0);
...
alter table reservation_major_conc add constraint pk_reservation_major_conc primary key (reservation_id, concentration_id);

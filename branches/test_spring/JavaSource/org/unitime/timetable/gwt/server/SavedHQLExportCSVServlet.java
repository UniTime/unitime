...
public class SavedHQLExportCSVServlet extends HttpServlet {
	...
	private SavedHQLService getSavedHQLService() {
		return (SavedHQLService)WebApplicationContextUtils.getWebApplicationContext(getServletContext()).getBean("hql.gwt");
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<String[]> report = getSavedHQLService().execute(q, params, 0, -1);

 ...
 */
 ...
 alter table course_offering add lastlike_demand number(10) default 0;
 
 alter table course_offering add constraint nn_course_offering_ll_demand check (lastlike_demand is not null);
...
update application_config set value='10' where name='tmtbl.db.version';

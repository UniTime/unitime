...
<tt:back-mark back="true" clear="true" title="Assigned Exams" uri="assignedExams.do"/>
<tiles:importAttribute />
<html:form action="/assignedExams">
		...
		<table width='100%' border='0' cellspacing='0' cellpadding='3'>
			<tr><td><i>
				...
				<logic:lessThan name="examReportForm" property="subjectArea" value="0">
					All examinations are not assigned.
				</logic:lessThan>
				<logic:greaterThan name="examReportForm" property="subjectArea" value="0">
					There are no examinations of <bean:write name="examReportForm" property="subjectAreaAbbv"/> subject area, or none of them is assigned.
				</logic:greaterThan>
			</i></td></tr>
		</table>
	</logic:empty>

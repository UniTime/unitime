...
public enum ApplicationProperty {
	...
	@DefaultValue("https://help.unitime.org/")
	...
	@Type(Boolean.class)
	@DefaultValue("false")
	@Description("Class Assignments: switch the user interface back to the old (Struts-based) class assignments page")
	...
	@Type(Boolean.class)
	@DefaultValue("false")
	@Description("Class Detail: switch the user interface back to the old (Struts-based) class detail page")
	...
	@Type(Boolean.class)
	@DefaultValue("false")
	@Description("Add/Edit Examination: switch the user interface back to the old (Struts-based) add/edit examination page")
	...
	@Type(Boolean.class)
	@DefaultValue("false")
	@Description("Examination Assignment Changes: switch the user interface back to the old (Struts-based) examination assignment changes page")
	LegacyExamAssignmentChanges("unitime.legacy.examChanges"),
	
	@Type(Boolean.class)
	@DefaultValue("false")
	@Description("Examination Reports: switch the user interface back to the old (Struts-based) examination report page (Examinations > Examination Timetabling > Reports)")
	LegacyExamAssignmentReport("unitime.legacy.examAssignmentReport"),
	
	@Type(Boolean.class)
	@DefaultValue("false")
	@Description("Examination Conflict-Based Statistics: switch the user interface back to the old (Struts-based) examination conflict-based statistics page")
	LegacyExamCBS("unitime.legacy.examCBS"),
	...
	@Type(Boolean.class)
	@DefaultValue("false")
	@Description("Examination PDF Reports: switch the user interface back to the old (Struts-based) examination PDF reports page")
	LegacyExamPdfReport("unitime.legacy.examPdfReport"),
	...
	@Type(Boolean.class)
	@DefaultValue("false")
	@Description("Chameleon: switch the user interface back to the old (Struts-based) chameleon page")
	LegacyChameleon("unitime.legacy.chameleon"),
	...
	@Type(Boolean.class)
	@DefaultValue("false")
	@Description("Academic Sessions: switch the user interface back to the old (Struts-based) academic sessions page")
	LegacySessions("unitime.legacy.sessions"),
	
	@Type(Boolean.class)
	@DefaultValue("false")
	@Description("Timetable Managers: switch the user interface back to the old (Struts-based) timetable managers page")
	LegacyManagers("unitime.legacy.managers"),
	
	@Type(Boolean.class)
	@DefaultValue("false")
	@Description("Solver Groups: switch the user interface back to the old (Struts-based) solver groups page")
	LegacySolverGroups("unitime.legacy.solverGroups"),
	
	@Type(Boolean.class)
	@DefaultValue("false")
	@Description("Last Changes: switch the user interface back to the old (Struts-based) last changes page")
	LegacyLastChanges("unitime.legacy.lastChanges"),
	
	@Type(Boolean.class)
	@DefaultValue("false")
	@Description("Date Patterns: switch the user interface back to the old (Struts-based) date patterns page")
	LegacyDatePatterns("unitime.legacy.datePatterns"),
	
	@Type(Boolean.class)
	@DefaultValue("false")
	@Description("Time Patterns: switch the user interface back to the old (Struts-based) time patterns page")
	LegacyTimePatterns("unitime.legacy.timePatterns"),
	...
	@Type(Boolean.class)
	@DefaultValue("false")
	@Description("Access Statistics: switch the user interface back to the old (Struts-based) access statistics page")
	LegacyAccessStats("unitime.legacy.accessStats"),
	...
	@Type(Boolean.class)
	@DefaultValue("false")
	@Description("Manage Solvers: switch the user interface back to the old (Struts-based) manage solvers page")
	LegacyManageSolvers("unitime.legacy.manageSolvers"),
	
	@Type(Boolean.class)
	@DefaultValue("false")
	@Description("Roll Forward Session: switch the user interface back to the old (Struts-based) roll forward session page")
	LegacyRollForward("unitime.legacy.rollForward"),
	
	@Type(Boolean.class)
	@DefaultValue("false")
	@Description("Status Types: switch the user interface back to the old (Struts-based) status types page")
	LegacyStatusTypes("unitime.legacy.statusTypes"),
	
	@Type(Boolean.class)
	@DefaultValue("false")
	@Description("Instructional Types: switch the user interface back to the old (Struts-based) instructional types page")
	LegacyItypes("unitime.legacy.itypes"),
	
	@Type(Boolean.class)
	@DefaultValue("false")
	@Description("Users: switch the user interface back to the old (Struts-based) users page")
	LegacyUsers("unitime.legacy.users"),

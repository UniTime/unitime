...
public class UniversalOverrideReservation extends BaseUniversalOverrideReservation {
	...
	public boolean isApplicable(Student student, CourseRequest request) {
		return getFilter() != null && !getFilter().isEmpty() && getStudentQuery().match(new DbStudentMatcher(student));
	}

...
public interface AcademicSessionLookup {
	...
	public SubjectArea findSubjectAreaForCampusYearTerm(String campus, String year, String term, String subjectAreaAbbreviation, org.hibernate.Session hibSession);

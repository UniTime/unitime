 ...
 * @author Tomas Muller
 */
@Service("org.unitime.timetable.export.Exporter:teaching-requests.pdf")
public class TeachingRequestsExportPDF extends TeachingRequestsExportCSV {
	@Override
	public String reference() { return "teaching-requests.pdf"; }

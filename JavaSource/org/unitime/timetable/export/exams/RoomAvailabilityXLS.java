...
@Service("org.unitime.timetable.export.Exporter:room-availability.xls")
public class RoomAvailabilityXLS extends ClassesXLS {
	
	@Autowired private ApplicationContext applicationContext;
	
	@Override
	public String reference() {
		return "room-availability.xls";
	}

 ...
 * @author Tomas Muller
 */
@Service("org.unitime.timetable.export.Exporter:unassigned-classes.csv")
public class ExportNotAssignedClassesCSV extends TableExporter {

	@Autowired private ApplicationContext applicationContext;

	@Override
	public String reference() {
		return "unassigned-classes.csv";
	}

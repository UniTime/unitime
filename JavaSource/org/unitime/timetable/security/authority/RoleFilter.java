 ...
 * @author Tomas Muller
 */
public class RoleFilter implements OtherAuthority {
	private String iRole;
	private Qualifiable[] iFilter;
	
	public RoleFilter(String role, Qualifiable... filter) {
		iRole = role;
		iFilter = filter;
	}
	...
	public boolean isMatch(UserAuthority authority) {
		if (iRole != null && !iRole.equals(authority.getRole())) return false;

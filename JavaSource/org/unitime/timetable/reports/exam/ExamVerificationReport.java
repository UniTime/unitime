            ...
            if (hasSubjectAreas()) {
            	for (SubjectArea subject: getSubjectAreas()) {
                    for (Object[] o: SessionDAO.getInstance().getSession().createQuery(
                            ...
                            "group by co.uniqueId", Object[].class).setParameter("subjectAreaId", subject.getUniqueId()).list()) {
                ...
                for (Object[] o: SessionDAO.getInstance().getSession().createQuery(
                        ...
                        "group by co.uniqueId", Object[].class).setParameter("sessionId", getSession().getUniqueId()).list()) {
                    courseLimits.put((Long)o[0],((Number)o[1]).intValue());
                }
            }
            ...
            if (hasSubjectAreas()) {
            	for (SubjectArea subject: getSubjectAreas()) {
                    for (Object[] o: SessionDAO.getInstance().getSession().createQuery(
                            ...
                            "group by c.uniqueId", Object[].class).setParameter("subjectAreaId", subject.getUniqueId()).list()) {
                ...
                for (Object[] o: SessionDAO.getInstance().getSession().createQuery(
                        ...
                        "group by c.uniqueId", Object[].class).setParameter("sessionId", getSession().getUniqueId()).list()) {
                    classLimits.put((Long)o[0],((Number)o[1]).intValue());
                }
            }
        }

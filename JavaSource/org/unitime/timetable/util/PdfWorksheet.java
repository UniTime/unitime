...
public class PdfWorksheet {
    ...
    private PdfWorksheet(File file, SubjectArea sa, String courseNumber) throws IOException, DocumentException  {
        ...
        iDoc.addAuthor(ApplicationProperties.getProperty("tmtbl.pdf.worksheet.author","UniTime 3.0."+Constants.BLD_NUMBER+", www.unitime.org"));
        iDoc.addSubject(sa.getSubjectAreaAbbreviation()+" -- "+sa.getSession());
        iDoc.addCreator("UniTime 3.0."+Constants.BLD_NUMBER+", www.unitime.org");
    ...
    protected void printHeader() throws DocumentException {
        out(renderMiddle(
                ApplicationProperties.getProperty("tmtbl.pdf.worksheet.author","UniTime 3.0."+Constants.BLD_NUMBER),

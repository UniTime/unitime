...
public class RoomSharingImport  extends BaseImport {
    ...
    public void loadXml(Element root) throws Exception {
        ...
        try {
            ...
            for (Location location: getHibSession().createQuery("from Location where session.uniqueId = :sessionId", Location.class).setParameter("sessionId", session.getUniqueId()).list()) {
            ...
            for (Department dept: getHibSession().createQuery("from Department where session.uniqueId = :sessionId", Department.class).setParameter("sessionId", session.getUniqueId()).list()) {

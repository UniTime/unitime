 ...
 * @author Tomas Muller
 */
public class SpecialRegistrationCancel implements OnlineSectioningAction<CancelSpecialRegistrationResponse> {
	private static final long serialVersionUID = 1L;
	private static StudentSectioningMessages MSG = Localization.create(StudentSectioningMessages.class);
	private CancelSpecialRegistrationRequest iRequest;
	
	public SpecialRegistrationCancel withRequest(CancelSpecialRegistrationRequest request) {
		iRequest = request;
		return this;
	}

	public CancelSpecialRegistrationRequest getRequest() { return iRequest; }
	public Long getStudentId() { return iRequest.getStudentId(); }
	
	
	@Override
	public CancelSpecialRegistrationResponse execute(OnlineSectioningServer server, OnlineSectioningHelper helper) {
		...
		try {
			...
			CancelSpecialRegistrationResponse response = CustomSpecialRegistrationHolder.getProvider().cancelRegistration(server, helper, student, getRequest());

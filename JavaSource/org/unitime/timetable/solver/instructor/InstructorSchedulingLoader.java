 ...
 * @author Tomas Muller
 */
public abstract class InstructorSchedulingLoader implements Runnable {
    private InstructorSchedulingModel iModel = null;
    private Assignment<TeachingRequest, TeachingAssignment> iAssignment = null;
    private Callback iCallback = null;
    
    /** Constructor 
     * @param model an empty instance of timetable model 
     */
    public InstructorSchedulingLoader(InstructorSchedulingModel model, Assignment<TeachingRequest, TeachingAssignment> assignment) {
        iModel = model;
     ...
     */
    protected InstructorSchedulingModel getModel() { return iModel; }
    
    /**
     * Returns provided assignment
     */
    protected Assignment<TeachingRequest, TeachingAssignment> getAssignment() { return iAssignment; }

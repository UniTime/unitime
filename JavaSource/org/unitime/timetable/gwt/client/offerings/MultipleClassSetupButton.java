 ...
 * @author Tomas Muller
 */
public class MultipleClassSetupButton extends AriaButton {
	protected static final CourseMessages MESSAGES = GWT.create(CourseMessages.class);
	private Long iConfigId = null;
	
	public MultipleClassSetupButton(boolean editable) {
		super(MESSAGES.actionClassSetup());
		setTitle(MESSAGES.titleClassSetup());

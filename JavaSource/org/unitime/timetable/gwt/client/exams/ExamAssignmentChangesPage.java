...
public class ExamAssignmentChangesPage extends Composite {
	...
	public ExamAssignmentChangesPage() {
	...
	protected void init() {
		RPC.execute(new ExamAssignmentChangesFilterRequest(), new AsyncCallback<ClassesFilterResponse>() {
			@Override
	...
	protected void search(final AsyncCallback<Boolean> callback) {
		final ExamAssignmentChangesRequest request = new ExamAssignmentChangesRequest();
	...
	protected void export(String format) {
		String sort = ToolBox.getSessionCookie("ExamAssignmentChanges.Sort");

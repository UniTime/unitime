...
public class AssignedExamsPage extends Composite {
	...
	protected void init() {
		RPC.execute(new AssignedExamsFilterRequest(), new AsyncCallback<ClassesFilterResponse>() {
			@Override
	...
	protected void search(final AsyncCallback<Boolean> callback) {
		final AssignedExamsRequest request = new AssignedExamsRequest();
	...
	protected void export(String format) {
		String sort = ToolBox.getSessionCookie("AssignedExams.Sort");

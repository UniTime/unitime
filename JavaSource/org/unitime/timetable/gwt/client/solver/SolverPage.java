...
public class SolverPage extends SimpleForm {
	...
	protected void populate(SolverPageResponse response) {
		...
		iSolverButtons.setEnabled("publish", response.canExecute(SolverOperation.PUBLISH));
		iSolverButtons.setEnabled("clone", response.canExecute(SolverOperation.CLONE));

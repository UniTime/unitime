...
public interface SectioningServiceAsync {
	...
	void sendEmail(Long sessionId, Long studentId, String subject, String message, String cc, Boolean courseRequests, Boolean classSchedule, Boolean advisorRequests, AsyncCallback<Boolean> callback) throws SectioningException, PageAccessException;

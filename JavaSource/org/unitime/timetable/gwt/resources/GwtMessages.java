...
public interface GwtMessages extends Messages {
	...
	@DefaultMessage("&copy; 2008 - 2020 The Apereo Foundation,<br>distributed under the Apache License, Version 2.")
	String pageCopyright();
	
	@DefaultMessage("UniTime {0}, \u00A9 2008 - 2020 The Apereo Foundation, distributed under the Apache License.")

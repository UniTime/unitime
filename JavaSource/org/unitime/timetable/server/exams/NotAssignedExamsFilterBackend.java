...
@GwtRpcImplements(NotAssignedExamsFilterRequest.class)
public class NotAssignedExamsFilterBackend implements GwtRpcImplementation<NotAssignedExamsFilterRequest, ClassesFilterResponse>{
	...
	@Override
	public ClassesFilterResponse execute(NotAssignedExamsFilterRequest request, SessionContext context) {

 ...
 * @author Tomas Muller
 */
@GwtRpcImplements(AssignmentChangesRequest.class)
public class AssignmentChangesBackend implements GwtRpcImplementation<AssignmentChangesRequest, AssignmentChangesResponse> {
	protected static GwtMessages MESSAGES = Localization.create(GwtMessages.class);
	
	@Autowired SolverService<InstructorSchedulingProxy> instructorSchedulingSolverService;
	
	@Override
	public AssignmentChangesResponse execute(AssignmentChangesRequest request, SessionContext context) {
